...
const AboutUs = () => {
  ...
  const modelContent = (
    <p>
      Incorrect coastal lighting causes sea turtle hatchlings to go towards the City instead of to the sea! <br />
      ...
      lights on Broward County beaches. However, STOP’s all night, volunteer rescue campaign is not the solution; correct, safe and night-healthy lighting is. Therefore, the focus of our program is to ensure the turtles do not lose their lives until municipalities adhere to and enforce the existing
      coastal light ordinances, as required by the Endangered Species Act and the Marine Turtle Protection Act. <br />
