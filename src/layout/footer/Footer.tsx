  ...
  return (
    <footer>
      ...
      <div className='footer-links'>
        <a className='footer-icon instagram-link' href='https://Instagram.com/seaturtleop/' target='_blank' rel='noopener noreferrer' />
        <a className='footer-icon facebook-link' href='https://Facebook.com/seaturtleop/' target='_blank' rel='noopener noreferrer' />
      </div>
